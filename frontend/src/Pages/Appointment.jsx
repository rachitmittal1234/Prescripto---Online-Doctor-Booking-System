        ...
        <div className='flex gap-3 items-center w-full overflow-x-auto mt-4'>
          {
            docSlots.length && docSlots.map((item,index)=>(
              <div onClick={()=>setSlotIndex(index)} className={`text-center py-6 min-w-16 rounded-full cursor-pointer ${slotIndex===index ? 'bg-blue-500 text-white' : 'border text-gray-400 border-gray-200'}`} key={index}>
